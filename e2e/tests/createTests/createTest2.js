const createTest2 = () => {
    describe('Another behavior test through the create event screens, test back buttons', () => {
        beforeAll(async () => {
        ...
        */
        ...
        it('Test back buttons', async () => {
            await element(by.id('finalizeScreenBack')).tap();
            await expect(element(by.id('selectDestinationsScreenView'))).toBeVisible();

            await element(by.id('selectDestinationsScreenBack')).tap();
            await expect(element(by.id('selectCategoriesScreenView'))).toBeVisible();

            await element(by.id('selectCategoriesScreenBack')).tap();
            await expect(element(by.id('mapSelectionScreenView'))).toBeVisible();

            await element(by.id('mapSelectionScreenBack')).tap();
