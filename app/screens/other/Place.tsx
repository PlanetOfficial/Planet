...
const Place = () => {
    return(
        <View style={styles.container}>
            <View style={styles.back}><Back fill={colors.black}/></View>
            <Text style={styles.name}>Share Tea but better</Text>
            <Text style={styles.category}>Bubble Tea Shop</Text>
            <View style={styles.shape2}><Shape2 fill={colors.fill}/></View>
            <View style={styles.shareButton}>
                <Svg width={60} height={60}>
                    <Circle stroke={colors.accent} strokeWidth={1.5} fill={colors.white} cx={30} cy={30} r={29}/>
                </Svg>
            ...
            <View style={styles.infoLeft}>
                ...
                <View style={styles.addressContainer}>
                    <Text style={styles.address}>4730 University Way NE{'\n'}Unit 109{'\n'}Seattle WA 98105{'\n'}United States</Text>
                </View>
            </View>
            <View style={styles.infoRight}>
                <Svg>
                    <Line x1={0} y1={110} x2={(W - 60) / 2} y2={110} stroke={colors.accent} strokeWidth={1.5}/>
                </Svg>
            </View>
        </View>
    );
