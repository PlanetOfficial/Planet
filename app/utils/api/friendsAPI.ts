...
export const getFriendRequests = async () : Promise<UserInfo[] | null> => {
  ...
  const response = await fetch(UserAPIURL + `/friend/request?authtoken=${authToken}`, {
    method: 'GET',
  });
...
export const acceptFriendRequest = async (id: number) : Promise<boolean> => {
  ...
  const response = await fetch(UserAPIURL + `/friend/accept/?requester=${id}&authtoken=${authToken}`, {
    method: 'POST',
  });
...
export const rejectFriendRequest = async (id: number) : Promise<boolean> => {
  ...
  const response = await fetch(UserAPIURL + `/friend/reject/?requester=${id}&authtoken=${authToken}`, {
    method: 'DELETE',
  });
...
export const deleteFriend = async (id: number) : Promise<boolean> => {
  ...
  const response = await fetch(UserAPIURL + `/friend?friend=${id}&authtoken=${authToken}`, {
    method: 'DELETE',
  });
